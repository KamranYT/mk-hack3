...
export const getProductsData = async () => {
  const res =
    await client.fetch(`*[_type=="product" && _id in ["gbTY3B2TxF1zfilLOh7Tff", "8ptia17TGb7SGzDviwYMzU", "gbTY3B2TxF1zfilLOh7ZwD", "BsnR1UsX7CpO8CtReEv8yI", "gbTY3B2TxF1zfilLOh7FG0", "gbTY3B2TxF1zfilLOh3UvS"]]{
    name,
    description,
    price,
    _id,
